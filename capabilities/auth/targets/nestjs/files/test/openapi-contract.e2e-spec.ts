...
// Contrat OpenAPI de la composition `base + auth` : sondes de santé + endpoints
// d'authentification. Ce spec REMPLACE (remplacement déclaré par l'overlay Auth)
// la variante `base` de la baseline.
