...
/**
 * Page technique de statut de la composition `base + auth` (`/status`). Ce fichier
 * REMPLACE (remplacement déclaré par l'overlay Auth) la page de la baseline pour
 * ajouter le panneau de session. Dynamique : précharge `health_get` par requête.
 */
