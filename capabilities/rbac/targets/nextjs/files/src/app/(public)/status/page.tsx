...
import { AuthorizationPanel } from "../../../features/authorization/authorization-panel.js";
...
/**
 * Page technique de statut de la composition `base + auth + rbac` (`/status`). Ce
 * fichier REMPLACE (remplacement déclaré par l'overlay RBAC) la variante d'Auth
 * pour ajouter le panneau d'autorisation. Dynamique : précharge `health_get`.
 */
