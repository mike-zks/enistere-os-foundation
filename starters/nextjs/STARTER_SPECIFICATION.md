# starter Next.js — Spécification du Core

## 1. Résumé exécutif

Le **starter Next.js** définit le socle web Next.js de référence pour les futures interfaces Enistere : landing pages, dashboards, backoffices, portails clients, SaaS, marketplaces, plateformes immobilières, outils internes, interfaces admin et espaces partenaires.
...
Le rôle du starter Next.js est de cadrer la base commune des applications web Enistere.
...
- assurer l'intégration avec starter NestJS, Deployment, UI Kit, Factory AI, Factory Quality et Documentation ;
- permettre une montée progressive vers un starter production-ready.

## 3. Objectifs du starter Next.js
...
- RBAC ;
- permissions fines ;
- alignement avec starter NestJS ;
...
Le starter Next.js doit s'intégrer avec starter NestJS pour :
...
Le starter Next.js doit s'intégrer avec Deployment pour :
...
## 49. Intégration avec starter React Native

Le starter Next.js doit rester cohérent avec starter React Native pour :
...
## 51. Intégration avec Factory AI
...
## 52. Intégration avec Factory Quality
...
## 53. Intégration avec Documentation

Documentation doit soutenir le Web Core pour :
...
### VF : starter Next.js complet production-ready
...
- [ ] L'intégration starter React Native est décrite.
