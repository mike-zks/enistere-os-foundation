# starter React Native — Spécification du Core

## 1. Résumé exécutif

Le **starter React Native** définit le socle mobile React Native / Expo de référence pour les futures applications Enistere.
...
Le rôle du starter React Native est de cadrer la base commune des applications mobiles Enistere.
...
- préparer l'intégration UI Kit, API Core, Deployment, Factory AI, Factory Quality et Documentation ;
- fournir un périmètre extensible pour maps, tracking, offline, notifications et modules avancés.

## 3. Objectifs du starter React Native
...
- Fournir un API client et une stratégie upload compatible starter NestJS.
...
Le starter React Native couvre :
...
- intégration possible avec OSRM via Deployment ;
...
## 47. Intégration avec starter NestJS

Le starter React Native doit s'intégrer avec starter NestJS pour :
...
## 48. Intégration avec Deployment

Le Mobile Core consomme les services exposés par Deployment via API ou endpoints publics sécurisés.
...
## 50. Intégration avec Factory AI

L'Factory AI peut aider à :
...
## 51. Intégration avec Factory Quality
...
Le starter React Native doit s'intégrer avec Documentation pour maintenir :
...
### VF : starter React Native complet production-ready
...
Le starter React Native doit devenir le socle mobile standard d'Enistere OS Foundation pour construire rapidement des applications mobiles sécurisées, cohérentes et maintenables.
