# API Core NestJS — Spécification du Core

## 1. Résumé exécutif

Le **API Core NestJS** définit le socle backend TypeScript de référence pour les futures APIs Enistere.
...
Le rôle du API Core NestJS est de servir de base backend réutilisable pour les projets Enistere qui nécessitent une API TypeScript.
...
## 3. Objectifs du API Core NestJS
...
Le API Core NestJS couvre le socle technique commun suivant :
...
- intégration avec Cloud Core ;
- intégration avec Mobile Core React Native ;
- intégration avec Web Core Next.js ;
- intégration avec UI Kit pour les contrats consommés par les interfaces ;
- intégration avec IA Core ;
- intégration avec Quality Core et Docs Core.
...
- mobile : stockage sécurisé côté Mobile Core React Native.
...
- stratégie de scaling à valider avec Cloud Core.
...
La stratégie OpenAPI avancée, notamment la génération de clients typés, doit être validée par ADR si elle devient structurante pour Mobile Core React Native ou Web Core Next.js.
...
L'observabilité avancée sera coordonnée avec Cloud Core et Quality Core.
...
## 34. Intégration avec Cloud Core

Le API Core NestJS doit s'intégrer avec Cloud Core pour :
...
## 35. Intégration avec Mobile Core React Native
...
## 36. Intégration avec Web Core Next.js
...
## 37. Intégration avec IA Core

Le API Core NestJS doit être exploitable par IA pour :
...
## 38. Intégration avec UI Kit, Quality Core et Docs Core

Le API Core NestJS doit aussi s'intégrer avec les cores transversaux suivants :
...
- l'intégration Cloud Core est claire ;
- l'intégration Mobile Core React Native est claire ;
- l'intégration Web Core Next.js est claire ;
- l'intégration UI Kit, Quality Core et Docs Core est claire ;
...
- Rendre Cloud Core implicitement dépendant de choix API non validés.
...
Le API Core NestJS est le premier core prioritaire de la fondation. Il doit devenir le socle backend TypeScript standard pour les projets Enistere, tout en restant générique, sécurisé, documenté et extensible.
