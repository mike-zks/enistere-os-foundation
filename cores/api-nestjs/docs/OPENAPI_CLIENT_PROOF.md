...
> `cores/api-nestjs/openapi/openapi.json`. **Aucun core client modifié, aucun Axios, aucun Orval installé.**
...
- **CI (ADR-013, hors `cores/api-nestjs/`)** : `generate:check` + détection de breaking changes
