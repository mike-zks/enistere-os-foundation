...
export class AuthController {
  ...
  @ApiErrorResponse(401, 'Authentification requise ou session invalide.')
  @ApiErrorResponse(500, 'Erreur interne.')
  authorization(@CurrentUser() principal: AuthenticatedPrincipal): Promise<AuthorizationSummary> {
    return this.authService.getAuthorizationSummary(principal.userId);
  }
}
