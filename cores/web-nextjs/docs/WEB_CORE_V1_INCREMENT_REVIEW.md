...
modifiés** : `cores/api-nestjs/`, `cores/mobile-react-native/`, `cores/cloud/`, `cores/ui-kit/`,
...
Ce document (`cores/web-nextjs/docs/WEB_CORE_V1_INCREMENT_REVIEW.md`). Complète
