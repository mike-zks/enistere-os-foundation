...
Revue du **Web Core** (`cores/web-nextjs`, `@enistere/web-nextjs` 0.1.0, privé) dans l'état
...
= `up-to-date`** (client consommé conforme au snapshot canonique `cores/api-nestjs/openapi/openapi.json`).
