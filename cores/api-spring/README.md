...
> Statut : **`VALIDE_V1`** (Spring Boot 7, 2026-07-15 — §30 14/15 ✅)
> Spécification cible : [`CORE_SPECIFICATION.md`](./CORE_SPECIFICATION.md)
> Stack : Spring Boot 4.1.0 + Spring Security 7.1.0 + JJWT 0.12.6 + PostgreSQL + Flyway 11 + MinIO SDK 8.5.17 + Java 21 (Maven — ADR-041)
...
## Structure (Spring Boot 7 — VALIDE_V1)
...
└── src/test/
    ...
    │   ├── infrastructure/storage/FakeStorageService.java  ← @Profile("test")
    │   ├── modules/
...
CorsIntegrationTest               :  2 tests (origin autorisée / inconnue)
