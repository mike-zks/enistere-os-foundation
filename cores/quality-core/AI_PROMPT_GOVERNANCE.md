...
> `cores/quality-core/QUALITY_GATES_MATRIX.md`, `docs/project-status/NEXT_ACTIONS.md`.
...
| Mission core | `strategy/04_ROADMAP_GLOBAL.md`, `strategy/05_EXECUTION_CHAIN.md`, `cores/<core>/CORE_SPECIFICATION.md` |
| Sécurité / auth / cloud / CI | `strategy/07_SECURITY.md`, ADR concernés, `cores/quality-core/QUALITY_GATES_MATRIX.md` |
| Release / statut | `cores/quality-core/RELEASE_PROCESS_RUNBOOK.md`, `docs/checklists/RELEASE_READINESS_CHECKLIST.md`, `CORE_STATUS_REVIEW_CHECKLIST.md` |
| Prompt IA | `strategy/10_AI_STRATEGY.md`, ce document, `prompts/README.md` |
...
Le template de référence est `prompts/global/mission-brief-template.md`.
...
Le catalogue vivant est `prompts/README.md`. Il référence :
