...
Ce runbook explique comment utiliser AI Core dans Enistere OS Foundation.
...
Une exécution AI Core n'autorise jamais :
...
## 4. Quand utiliser AI Core

AI Core est adapté pour :
...
4. Choisir un prompt existant dans `cores/ai-core/prompt-registry.json`.
...
Pour une mission AI Core runtime-local :
...
Pour une mission docs-only AI Core :
...
Ce runbook ferme B3 de la revue AI Core V1.

La prochaine action naturelle est une **AI Core V1 Final Readiness Decision** pour vérifier si B1, B2 et B3
