/**
 * Tests for AI Core Context Builder.
 *
 * Run:
...
async function createRepo() {
  ...
  await writeFile(join(root, 'prompts/global/master-context.md'), '# Master\nAuthorization: Bearer abc.def.ghijklmnop\n');
...
describe('normalizeContextPath', () => {
  it('normalizes simple relative paths', () => {
    ...
    assert.equal(normalizeContextPath('prompts\\global\\master-context.md'), 'prompts/global/master-context.md');
  });
...
describe('buildContext', () => {
  it('builds a redacted context from explicit files only', async () => {
    ...
    assert.match(context.safeText, /## prompts\/global\/master-context\.md/);
