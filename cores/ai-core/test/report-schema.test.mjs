...
function validInput(overrides = {}) {
  return {
    ...
    documentsRead: [
      ...
      'cores/ai-core/CORE_SPECIFICATION.md',
    ],
    modifiedFiles: [
      'cores/ai-core/src/reports/execution-report.mjs',
    ],
    gates: [
      { command: 'node --test cores/ai-core/test/report-schema.test.mjs', status: 'pass' },
      { command: 'node cores/quality-core/scripts/quality-gates.mjs run docs', status: 'pass' },
    ],
