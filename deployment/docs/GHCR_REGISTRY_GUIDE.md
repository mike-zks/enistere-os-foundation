# Guide GHCR — images Enistere (Deployment 5 + smoke-run CC8)
...
> ✅ **Validité des images API (Deployment 8 / 8B)** : l'image API corrigée est **publiée** depuis le merge CC8
...
|---|---|---|---|
| `ghcr.io/<owner>/<repo>/api-nestjs` | `starters/nestjs/Dockerfile` | `starters/nestjs/` | NestJS, non-root, `node dist/main.js`, port 3000 |
| `ghcr.io/<owner>/<repo>/web-nextjs` | `starters/nextjs/Dockerfile` | **racine** du monorepo | Next.js **standalone**, non-root, `node starters/nextjs/server.js`, port 3000 |
