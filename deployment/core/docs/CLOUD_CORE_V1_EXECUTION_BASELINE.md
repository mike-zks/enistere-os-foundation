...
> Source de vérité : le repository réel + `deployment/core/CORE_SPECIFICATION.md`. Date : 2026-06-10.
>
...
**Staging V1** : `deployment/core/staging/docker-compose.cc10.yml` est le compose serveur/staging V1 officiel
