...
```bash
bash deployment/core/staging/scripts/backup-postgres.sh \
...
```bash
bash deployment/core/staging/scripts/backup-minio.sh \
  /home/deploy/enistere-staging/.env.staging \
...
```bash
bash deployment/core/staging/scripts/rotate-smoke-account.sh \
  /home/deploy/enistere-staging/.env.staging \
  <smoke-account-email>
```
