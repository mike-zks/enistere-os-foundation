...
test('passes a complete local mission report', () => {
  const result = evaluateAiOutput({
    outputText: [
      ...
      'Files: factory/ai/core/src/evaluation/evaluation-harness.mjs.',
      'Verification: node --test factory/ai/core/test/evaluation-harness.test.mjs.',
    ...
    modifiedFiles: ['factory/ai/core/src/evaluation/evaluation-harness.mjs'],
    allowedFiles: ['factory/ai/core/'],
...
test('fails when modified files are forbidden or outside allowed scope', () => {
  const result = evaluateAiOutput({
    ...
    modifiedFiles: [
      ...
      '.env',
      'factory/ai/core/src/evaluation/evaluation-harness.mjs',
    ],
    allowedFiles: ['factory/ai/core/'],
...
test('fails when an expected verification gate is missing', () => {
  const result = evaluateAiOutput({
    ...
    expectedGates: ['node --test factory/ai/core/test/evaluation-harness.test.mjs'],
  });
...
test('throws for invalid array inputs', () => {
  ...
  assert.throws(
    () => evaluateAiOutput({ allowedFiles: 'factory/ai/core' }),
