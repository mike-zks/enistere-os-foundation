/**
 * AI Core Governance / Execution Report schema tests.
 *
 * Run:
...
function validInput(overrides = {}) {
  return {
    ...
    documentsRead: [
      ...
      'factory/ai/core/CORE_SPECIFICATION.md',
    ],
    modifiedFiles: [
      'factory/ai/core/src/reports/execution-report.mjs',
    ],
    gates: [
      { command: 'node --test factory/ai/core/test/report-schema.test.mjs', status: 'pass' },
      { command: 'node factory/quality/core/scripts/quality-gates.mjs run docs', status: 'pass' },
    ],
    ...
    nextAction: 'AI Core V1 Readiness Review.',
    ...overrides,
  };
}
