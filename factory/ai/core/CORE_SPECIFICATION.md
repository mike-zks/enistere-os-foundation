...
- `factory/quality/core/AI_PROMPT_GOVERNANCE.md` pour la gouvernance des prompts ;
- `factory/ai/prompts/README.md` pour le catalogue initial ;
...
Source actuelle : `factory/ai/prompts/`.
