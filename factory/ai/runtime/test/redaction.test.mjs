/**
 * Tests for Factory AI Redaction Layer.
 *
 * Run:
 *   node --test factory/ai/runtime/test/redaction.test.mjs
 */
...
describe('redactText', () => {
  ...
  it('leaves ordinary text intact', () => {
    const text = 'Factory AI prompt registry validation passed for 8 prompts.';
