/**
 * Factory AI Evaluation Harness tests.
 *
 * Run:
 *   node --test factory/ai/runtime/test/evaluation-harness.test.mjs
 */
...
test('passes a complete local mission report', () => {
  const result = evaluateAiOutput({
    outputText: [
      'Summary: Factory AI 6 completed.',
      'Files: factory/ai/runtime/src/evaluation/evaluation-harness.mjs.',
      'Verification: node --test factory/ai/runtime/test/evaluation-harness.test.mjs.',
    ...
    modifiedFiles: ['factory/ai/runtime/src/evaluation/evaluation-harness.mjs'],
    allowedFiles: ['factory/ai/runtime/'],
...
test('fails when modified files are forbidden or outside allowed scope', () => {
  const result = evaluateAiOutput({
    ...
    modifiedFiles: [
      'starters/nextjs/src/app/page.tsx',
      '.env',
      'factory/ai/runtime/src/evaluation/evaluation-harness.mjs',
    ],
    allowedFiles: ['factory/ai/runtime/'],
    forbiddenFiles: ['starters/nextjs'],
  });
...
test('fails when an expected verification gate is missing', () => {
  const result = evaluateAiOutput({
    ...
    expectedGates: ['node --test factory/ai/runtime/test/evaluation-harness.test.mjs'],
  });
...
test('throws for invalid array inputs', () => {
  ...
  assert.throws(
    () => evaluateAiOutput({ allowedFiles: 'factory/ai/runtime' }),
