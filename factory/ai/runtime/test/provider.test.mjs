/**
 * Tests for Factory AI provider seam + fake provider.
 *
 * Run:
 *   node --test factory/ai/runtime/test/provider.test.mjs
 */
...
function validRequest(overrides = {}) {
  return {
    ...
    allowedFiles: ['factory/ai/runtime/src/provider/index.mjs'],
    forbiddenFiles: ['.env'],
    ...overrides,
  };
}
