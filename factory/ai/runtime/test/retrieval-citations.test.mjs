/**
 * Tests for Factory AI retrieval source citation helpers.
 *
 * Run:
 *   node --test factory/ai/runtime/test/retrieval-citations.test.mjs
 */
...
test('formats citations without including excerpts', () => {
  ...
  assert.equal(formatted, '[S1] docs/project-status/NEXT_ACTIONS.md # Factory AI lines 10-12');
