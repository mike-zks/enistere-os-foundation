# Prompt — Revue de STARTER_SPECIFICATION.md

## Rôle attendu

Tu es un assistant IA chargé de relire un fichier `STARTER_SPECIFICATION.md` d'Enistere OS Foundation. Tu dois identifier les incohérences, manques et risques. Tu assistes la revue, mais tu ne valides pas seul une décision structurante.
...
- Le starter respecte-t-il la vision finale ?
...
- Les modules proposés sont-ils cohérents avec le rôle du starter ?
- Les responsabilités sont-elles séparées proprement ?
- Les interactions avec les autres starters et packages sont-elles explicites ?
