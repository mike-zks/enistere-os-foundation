...
| Files + Flutter | `node factory/quality/scripts/golden-runtime.mjs fastapi-flutter-files` | Python 3.14, Flutter 3.44.6, PostgreSQL 16 + MinIO | **golden-runtime** | chaque PR |
