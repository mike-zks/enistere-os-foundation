...
| `images (api-nestjs, ./starters/nestjs, ./starters/nestjs/Dockerfile)` | `jobs.images` (matrix) | build image API (constructibilité en PR, sans push) |
| `images (web-nextjs, ., ./starters/nextjs/Dockerfile)` | `jobs.images` (matrix) | build image Web (constructibilité en PR, sans push) |
...
Optionnel (phase 2) :
- `images (api-nestjs, ./starters/nestjs, ./starters/nestjs/Dockerfile)`
- `images (web-nextjs, ., ./starters/nextjs/Dockerfile)`
...
echo "# test" >> factory/quality/core/BRANCH_PROTECTION_RUNBOOK.md
git add factory/quality/core/BRANCH_PROTECTION_RUNBOOK.md
