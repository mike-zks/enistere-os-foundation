...
Voir `deployment/core/docs/CC11_OPERATIONAL_RUNBOOK.md`.
...
- `node --test factory/quality/core/scripts/quality-gates.test.mjs` : 36/36 ✓
- `node factory/quality/core/scripts/quality-gates.mjs plan docs` : plan affiché ✓
...
> Helper local disponible : `node factory/quality/core/scripts/release-helper.mjs draft ...`.
...
# Exécuter
node factory/quality/core/scripts/quality-gates.mjs run all-safe
```
...
- Ajout de `factory/quality/core/RELEASE_PROCESS_RUNBOOK.md` — 5 types de release, 8 étapes de préparation
