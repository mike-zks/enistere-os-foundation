#!/usr/bin/env node
/**
 * release-helper.mjs — Quality Core : assistant local de preparation release.
 *
 * Usage :
...
export const RELEASE_TYPES = Object.freeze({
  ...
  'quality-v2-increment': Object.freeze({
    label: 'Quality Core V2 increment',
    recommendedGates: Object.freeze([
      'node factory/quality/core/scripts/quality-gates.mjs run docs',
    ...
    defaultExcluded: Object.freeze([
      ...
      'Cloud staging réel — hors scope Quality Core',
    ]),
  }),
...
Usage :
  node factory/quality/core/scripts/release-helper.mjs types
  node factory/quality/core/scripts/release-helper.mjs draft --type <type> --version <version> --since <ref> [--to <ref>] [--scope <label>]
