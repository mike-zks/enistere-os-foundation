...
export const QUALITY_SCOPES = Object.freeze([
  ...
  Object.freeze({
    id: 'quality-core',
    label: 'factory/quality/core',
    packageJson: null,
    testCommand: 'node --test factory/quality/core/scripts/*.test.mjs',
  ...
  Object.freeze({
    ...
    label: 'factory/quality/core',
    packageJson: null,
    testCommand: 'node --test factory/quality/core/scripts/check-doc-links.test.mjs',
