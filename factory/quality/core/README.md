...
| `../../ai/prompts/README.md` | Catalogue gouverné des prompts IA versionnés |
| `../../ai/prompts/global/mission-brief-template.md` | Template de mission Claude/Codex/Gemini gouvernée |
...
node factory/quality/core/scripts/quality-gates.mjs plan <scope>

# Exécuter les gates du scope (arrêt au premier échec)
node factory/quality/core/scripts/quality-gates.mjs run <scope>
```
...
```bash
node factory/quality/core/scripts/quality-gates.test.mjs
...
### deployment/core (gates finaux staging — non locaux)
```bash
...
|---|---|---|
| docs-only (project-status, ADR, checklists) | `node factory/quality/core/scripts/quality-gates.mjs run docs` | `npm audit` root |
