...
- Revue humaine
- Gates Factory Quality minimaux verts en local
...
**Critères** :
- `QUALITY_SPECIFICATION.md` du core : critères de validation vérifiés un par un
...
**Périmètre** : livraison d'un incrément documentaire ou outillage Factory Quality (QC1–QCN).

**Critères** :
- Aucun workflow GitHub modifié
- Aucune dépendance ajoutée
- Aucun changement runtime
- `node --test factory/quality/scripts/quality-gates.test.mjs` : 36/36 ✓
- `node factory/quality/scripts/quality-gates.mjs plan docs` : plan affiché ✓
...
> Helper local disponible : `node factory/quality/scripts/release-helper.mjs draft ...`.
...
### Étape 4 — Sélectionner les gates Factory Quality appropriés

Selon le scope de la release :

| Scope release | Scope Factory Quality recommandé |
|---|---|
...
1. Créer le tag Git selon la convention §7 :
   ```bash
   git tag -a quality-v2.5 -m "Factory Quality 5 — release process runbook"
...
- Factory Quality : `SPECIFICATION_DOCUMENTAIRE` (QC5 — processus de release documenté)
- (autres cores si applicable)

### Changements fonctionnels

- Ajout de `factory/quality/RELEASE_PROCESS_RUNBOOK.md` — 5 types de release, 8 étapes de préparation
...
| Factory Quality incrément | `quality-vX.N` | `quality-v2.5` |
...
## 8. Relation avec les gates Factory Quality
