#!/usr/bin/env node
/**
 * quality-report.mjs — Factory Quality : synthese locale tests/couverture.
 *
 * Usage :
...
export const QUALITY_SCOPES = Object.freeze([
  ...
  Object.freeze({
    ...
    packageJson: 'packages/ui-kit/package.json',
  ...
  Object.freeze({
    ...
    packageJson: 'starters/nextjs/package.json',
  ...
  Object.freeze({
    id: 'web-angular',
    label: 'starters/angular',
    packageJson: 'starters/angular/package.json',
    testCommand: 'cd starters/angular && npm run test:ci',
    expectedTests: '267',
    coverageCommand: null,
    ciLevel: 'L6',
  ...
  Object.freeze({
    ...
    label: 'starters/react-native',
    packageJson: 'starters/react-native/package.json',
    testCommand: 'cd starters/react-native && npm test',
    expectedTests: '367',
    coverageCommand: null,
    ciLevel: 'local',
  ...
  Object.freeze({
    id: 'api-nestjs',
    label: 'starters/nestjs',
    packageJson: 'starters/nestjs/package.json',
    testCommand: 'cd starters/nestjs && npm test',
    expectedTests: '386 unit + 101 e2e CI',
    coverageCommand: 'cd starters/nestjs && npm run test:cov',
    ciLevel: 'L2',
  ...
  Object.freeze({
    ...
    packageJson: null,
    testCommand: 'node --test factory/quality/scripts/*.test.mjs',
  ...
  Object.freeze({
    ...
    label: 'factory/quality',
    packageJson: null,
    testCommand: 'node --test factory/quality/scripts/check-doc-links.test.mjs',
