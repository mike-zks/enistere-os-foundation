#!/usr/bin/env node
/**
 * quality-gates.mjs — Factory Quality 2 : sélection et exécution des gates qualité locaux sûrs.
 *
 * Usage :
 *   node factory/quality/scripts/quality-gates.mjs list
 *   node factory/quality/scripts/quality-gates.mjs plan <scope>
 *   node factory/quality/scripts/quality-gates.mjs run <scope>
 *
...
// mobile command (run in starters/react-native)
function mob(script) {
...
const SCOPE_GATES = {
  docs: [
    ...
    step('docs: internal link check', 'node', ['factory/quality/scripts/docs-link-check.mjs']),
  ],
...
export const SCOPE_DESCRIPTIONS = {
  docs:
    'Vérifie les espaces blancs git et les liens Markdown internes Documentation. Docs-only.',
  'root-audit':
