...
> `factory/quality/QUALITY_GATES_MATRIX.md`, `docs/project-status/NEXT_ACTIONS.md`.
> Statut : **Factory Quality 7 — prompts IA standardisés**.
...
- vérifiables par des gates Factory Quality ;
...
| Mission starter | `strategy/04_ROADMAP_GLOBAL.md`, `strategy/05_EXECUTION_CHAIN.md`, `starters/<starter>/STARTER_SPECIFICATION.md` |
| Sécurité / auth / cloud / CI | `strategy/07_SECURITY.md`, ADR concernés, `factory/quality/QUALITY_GATES_MATRIX.md` |
| Release / statut | `factory/quality/RELEASE_PROCESS_RUNBOOK.md`, `docs/checklists/RELEASE_READINESS_CHECKLIST.md`, `CORE_STATUS_REVIEW_CHECKLIST.md` |
...
| Factory Quality | gates, checklists, templates, prompts | `quality-gates.test`, `plan docs`, audit root |
