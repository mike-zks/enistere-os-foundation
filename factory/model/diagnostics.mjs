...
export const CSM_DIAGNOSTIC_CODES = Object.freeze({
  ...
  INVALID_OWNERSHIP: 'CSM_INVALID_OWNERSHIP',
  INVALID_COMMUNICATION: 'CSM_INVALID_COMMUNICATION',
  INCOHERENT_COMMUNICATION_GRAPH: 'CSM_INCOHERENT_COMMUNICATION_GRAPH',
  INVALID_SYSTEM_PROFILE: 'CSM_INVALID_SYSTEM_PROFILE',
  INVALID_ARCHITECTURE_DIMENSION: 'CSM_INVALID_ARCHITECTURE_DIMENSION',
  INCOHERENT_ARCHITECTURE_PROFILE: 'CSM_INCOHERENT_ARCHITECTURE_PROFILE',
...
export const RESOLUTION_DIAGNOSTIC_CODES = Object.freeze({
  ...
  CAPABILITY_CONFLICT: 'RESOLUTION_CAPABILITY_CONFLICT',
