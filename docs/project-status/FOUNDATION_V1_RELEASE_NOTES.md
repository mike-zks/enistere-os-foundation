...
| Gate | Résultat |
|---|---|
| `env NODE_ENV=test node factory/quality/scripts/quality-gates.mjs run all-safe` | PASS jusqu'au gate audit (16/17) |
| `npm audit` root hors sandbox réseau | 0 vulnérabilité |
| `git diff --check` | 0 erreur |
| `node --test factory/quality/scripts/quality-gates.test.mjs` | PASS |
| `node factory/quality/scripts/quality-gates.mjs plan docs` | PASS |
