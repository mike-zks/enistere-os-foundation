...
- **Docs Core** : **IMPLEMENTATION_PARTIELLE** (2026-07-12) — `cores/docs-core/CORE_SPECIFICATION.md`,
  ...
  Decision de revue V2 : maintien `IMPLEMENTATION_PARTIELLE` ; guides principaux + onboarding complet requis
  avant `IMPLEMENTATION_AVANCEE`.
...
**Action unique suivante** : Docs Core 5 — guides principaux et onboarding complet.
Détail :
