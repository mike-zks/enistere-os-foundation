...
- **Vides** : `ai-core`. **`web-angular`** → **`TEST_SMOKE_READY`** (Angular 8, 2026-07-16) : 16 tests ajoutés — `RouterTestingHarness` (5 tests intégration router) + CDK harnesses login/upload/loading (11 tests). 224/224 tests ✅. Prochaine action : **Web Core Angular V1 Readiness Review**.
