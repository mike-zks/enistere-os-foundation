...
- **`TEST_WIDGET_PASSED`** : `mobile-flutter` (Flutter 6, 2026-07-14 — 136/136 tests headless, widget tests splash/sign-in/home, `integration_test/smoke_test.dart` procédure device, `scripts/smoke.sh`, rapport `MOBILE_FLUTTER6_SMOKE_REPORT.md` ; Android bloqué architecture library, iOS bloqué Linux).
