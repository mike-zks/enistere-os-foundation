...
`mobile-react-native` (un `CORE_SPECIFICATION.md`, **pas** de starter). **`cloud`** : spéc + README + `docs/`
de **cadrage opérationnel** (Cloud Core 1) — **pas** de starter/infra réelle (`CADRAGE_OPERATIONNEL`).
