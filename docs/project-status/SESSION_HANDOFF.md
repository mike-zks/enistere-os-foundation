...
- **Vides** : `ai-core`. **`web-angular`** → **`FORMS_MATERIAL_READY`** (Angular 5, 2026-07-16) : Angular Material form fields sur login — `mat-form-field` outline, `matInput`, `mat-error` + `getFieldError()` pur (required/email/minlength/maxlength/pattern), `mat-flat-button`, SCSS nettoyé. Construit sur Angular 4 (HTTP/server-state). 136/136 tests ✅. Prochaine action : **Web Core Angular 6 — Composants Foundation Enistere**.
