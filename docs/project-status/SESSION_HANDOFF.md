...
- **Vides** : `ai-core`. **`web-angular`** → **`VALIDE_V1`** (Angular V1 Readiness Review, 2026-07-16) : 11/15 §29 SATISFAIT + 4/15 PARTIEL ; réserves R1–R4 formellement acceptées non-bloquantes (R1 RefreshInterceptor/seam, R2 PermissionDirective/projet dérivé, R3 CDK a11y FocusTrap/ARIA HTML, R4 CI gate/§32). 224/224 tests ✅. Rapport : `WEB_ANGULAR_V1_READINESS_REVIEW.md`. Prochaine action : **Web Core Angular V2** (CI gate + RefreshInterceptor + PermissionDirective + E2E).
