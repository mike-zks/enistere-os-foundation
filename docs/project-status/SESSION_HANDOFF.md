...
- **`IMPLEMENTATION_AVANCEE`** : `mobile-flutter` (Flutter V1 Readiness Review, 2026-07-14 — rapport `MOBILE_FLUTTER_V1_READINESS_REVIEW.md` ; §29 5/11 satisfaits ; bloquants B1 Android runtime / B2 SecureStorage / B3 RefreshInterceptor / B4 UI states / B5 login form ; réserves R1 iOS Linux / R2 pas backend / R3 Freezed / R4 logger / R5 PreferenceStore ; prochain : Flutter 7 — platform dirs + smoke Android).
