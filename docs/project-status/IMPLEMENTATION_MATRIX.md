...
> `web-angular` : **`FOUNDATION_STATES_READY` → `UPLOAD_READY`**. Prochaine action :
...
| Web Core Angular | ✓ | **✓ (`CORE_SPECIFICATION.md` 32 §, `README.md` — Angular 1, 2026-07-15)** | **ADR-035 (Validé, 2026-07-15)** | **✓ (Angular 2 starter + Angular 3 auth/routing + Angular 4 HTTP/server-state + Angular 5 `mat-form-field`+`matInput`+`mat-error`+`getFieldError()` + Angular 6 Foundation state components + Angular 7 Upload fichiers)** | **✓ (Angular 3→7 — HTTP, intercepteurs, server-state RxJS, Angular Material, Foundation states, FileCategory/AppFile/UploadService/UploadFormComponent)** | **✓ (205/205 ; Angular 3→6 + 35 nouveaux tests Angular 7 : FormData, no Content-Type, 413/415/401 mapping, form validation, state components, no filename leak)** | — | **UPLOAD_READY** | `architect web-angular:build` SUCCESS · `architect web-angular:test` 205/205 ✅ · `npm audit` 0 vuln | Web Core Angular 8 — Tests + smoke |
