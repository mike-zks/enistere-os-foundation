...
| `@enistere/api-contracts` | ✓ | n/a | ✓ (016) | ✓ | ✓ | ✓ (12 + `pack:dry-run`) | ✓ (`PACKAGES_DISTRIBUTION_2_PUBLISH_READY_REPORT.md`) | **IMPLEMENTATION_AVANCEE** (publish-ready, non publié) | build + generate:check ; `npm pack --dry-run` OK ; distribution cible GitHub Packages, repli GitHub Release tarballs | Packages Release 1 : publication contrôlée ou release tarballs |
| `@enistere/api-client-fetch` | ✓ | n/a | ✓ (011,012,016) | ✓ | ✓ | ✓ (30 + live 16/16 + `pack:dry-run`) | ✓ (`PACKAGES_DISTRIBUTION_2_PUBLISH_READY_REPORT.md`) | **IMPLEMENTATION_AVANCEE** (publish-ready, non publié) | live 16/16 ; **instancié (public + authentifié/BFF Auth + façade Files lecture) dans le Web Core** ; `npm pack --dry-run` OK | Packages Release 1 : publication contrôlée ou release tarballs |
