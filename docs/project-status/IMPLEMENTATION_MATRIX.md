...
| Docs Core | ✓ | ✓ | — | — | — | — | — | **SPECIFICATION_DOCUMENTAIRE** | `CORE_SPECIFICATION.md` + `README.md` + `docs/README.md` index central | Docs Core 2 — audit documentaire et dette de navigation/liens |
