...
| Mobile Core React Native | ✓ | ✓ | ✓ (010,012,015…) | — | — | — | — | **SPECIFICATION_DOCUMENTAIRE** | — | **PROCHAINE PRIORITÉ (V1 #2)** — Mobile Core RN 1 (starter Expo/RN ; dépendances API+packages+tokens RN-safe satisfaites) |
