...
| Docs Core | ✓ | ✓ | — | — | ✓ (script link check) | ✓ (`check-doc-links.test.mjs`) | ✓ (`DOCS_CORE_NAVIGATION_AUDIT.md`, `DOCS_CORE_LINK_CHECK_REPORT.md`) | **IMPLEMENTATION_PARTIELLE** | index central + audit navigation + onboarding + glossaire + link check 52 fichiers | Docs Core V2 Readiness Review |
