...
| Web Core Next.js | ✓ | ✓ | ✓ (005,009,011,012,016…) | **✓** | **✓ (App Router + UI Kit + API publique Health + TanStack Query, SSR/hydratation)** | **✓ (79, a11y + sonde HTTP + preuve API réelle)** | — | **IMPLEMENTATION_PARTIELLE** | build/lint/typecheck/79 tests verts + preuve API réelle (Health/live/ready, hydratation, API down→contrôlé) | Auth/BFF (cookies HttpOnly, CSRF — ADR-005/011) |
