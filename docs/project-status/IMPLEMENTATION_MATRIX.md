...
| AI Core | ✓ | ✓ (`CORE_SPECIFICATION.md`, `README.md` — AI Core 1, 2026-07-16) | — | — | ✓ (`prompt-registry.json` + validateur Node pur + redaction layer + context builder — AI Core 2/3/4) | ✓ (tests Node + validation registry + redaction + context) | — | **PREUVE_TECHNIQUE** | `validate-prompt-registry` + `node --test` + `quality-gates docs` | AI Core 5 — Provider adapter seam + fake provider |
