...
| Web Core Next.js | ✓ | ✓ | ✓ (004,005,009,011,012,016…) | **✓** | **✓ (App Router + UI Kit + API publique Health + TanStack Query + BFF Auth login/refresh/logout + CSRF)** | **✓ (169, a11y + sonde HTTP + preuve API réelle Auth)** | — | **IMPLEMENTATION_PARTIELLE** | build/lint/typecheck/169 tests verts + preuve API réelle (login/refresh/logout, cookies HttpOnly, CSRF, Origin, rotation) | Web Auth 3 (me/authorization + session TanStack Query) |
