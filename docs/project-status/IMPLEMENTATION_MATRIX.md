...
> Blockers V1 fermés : **B1 RefreshInterceptor/login API seam** (Angular 9) + **B2 PermissionService/PermissionDirective** (Angular 10). Réserves non-bloquantes : R1 CDK a11y FocusTrap/LiveAnnouncer (ARIA HTML équivalent), R2 CI Angular gate (non §29, reporté §32).
