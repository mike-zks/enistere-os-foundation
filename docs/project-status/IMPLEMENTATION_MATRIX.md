...
| AI Core | ✓ | ✓ (`CORE_SPECIFICATION.md`, `README.md` — AI Core 1, 2026-07-16) | — | — | ✓ (`prompt-registry.json` + validateur Node pur + redaction layer — AI Core 2/3) | ✓ (tests Node + validation registry + redaction) | — | **PREUVE_TECHNIQUE** | `validate-prompt-registry` + `node --test` + `quality-gates docs` | AI Core 4 — Context builder allow-list |
