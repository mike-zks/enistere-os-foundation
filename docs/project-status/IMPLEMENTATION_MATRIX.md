...
| AI Core | ✓ | ✓ (`CORE_SPECIFICATION.md`, `README.md` — AI Core 1, 2026-07-16) | — | — | ✓ (`prompt-registry.json` + validateur Node pur — AI Core 2) | ✓ (tests Node + validation registry) | — | **PREUVE_TECHNIQUE** | `validate-prompt-registry` + `node --test` + `quality-gates docs` | AI Core 3 — Redaction layer pure + tests |
