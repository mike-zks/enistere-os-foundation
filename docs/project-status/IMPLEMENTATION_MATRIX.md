...
| AI Core | ✓ | ✓ (`CORE_SPECIFICATION.md`, `README.md` — AI Core 1, 2026-07-16) | — | — | — (documentaire uniquement : aucun SDK/provider/RAG/runtime) | — | — | **SPECIFICATION_DOCUMENTAIRE** | `quality-gates docs` + `git diff --check` | AI Core 2 — Prompt registry model + validator local |
