...
| Conformité produit de capability | **Implémenté pour `auth`** (ADR-068) | contrat neutre versionné, invariants par rôle, preuves vérifiées en Foundation et en application matérialisée ; RBAC et Files non couverts |
