...
| `@enistere/api-contracts` | ✓ | n/a | ✓ (016) | ✓ | ✓ | ✓ (12) | ✓ (`PACKAGES_DISTRIBUTION_DECISION.md`) | **IMPLEMENTATION_AVANCEE** (local, distribution décidée) | build + generate:check ; distribution cible GitHub Packages, repli GitHub Release tarballs | Packages Distribution 2 : publish-ready sans publication |
| `@enistere/api-client-fetch` | ✓ | n/a | ✓ (011,012,016) | ✓ | ✓ | ✓ (30 + live 16/16) | ✓ (`PACKAGES_DISTRIBUTION_DECISION.md`) | **IMPLEMENTATION_AVANCEE** (local, distribution décidée) | live 16/16 ; **instancié (public + authentifié/BFF Auth + façade Files lecture) dans le Web Core** ; distribution cible GitHub Packages, repli GitHub Release tarballs | Packages Distribution 2 : publish-ready sans publication |
