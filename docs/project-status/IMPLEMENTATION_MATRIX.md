...
> **Mise à jour RN34/UI Kit 4/5/6** : Mobile Core React Native est désormais
> **`STARTER_EXPO_DOCTOR_GREEN`** (RN34 + smoke Android RN34B passé ; RN31 iOS reste bloqué par
> l'absence d'hôte macOS/Xcode). Le UI Kit expose désormais **19 primitives Web React** (UI Kit 4 :
> Dialog/Select/Toast + UI Kit 5 : Badge/Divider/Skeleton + **UI Kit 6 : LoadingState/EmptyState/ErrorState/SuccessState**) avec **181 tests** ; `Dialog` est explicitement marqué `'use client'`
