...
| UI Kit | ✓ | ✓ | ✓ (008,009,010) | — | — | — | — | **SPECIFICATION_DOCUMENTAIRE** | — | **starter minimal (prochaine action)** |
...
| C6 | `cores/{cloud,web-nextjs,mobile-react-native,ui-kit}` ont une spéc | Aucun starter | Documentaires | Confusion spéc↔implémentation | Statut explicite (cette matrice) | IMPORTANTE |
