...
| Mobile Core Flutter | ✓ | ✓ (spec 32 §) | ADR-034 (Validé) | ✓ (starter Flutter 2) | ✓ (auth shell Flutter 3) | — | — | **AUTH_SHELL_READY** | Flutter 3 : `AuthController` + `SessionStore` seam + GoRouter guards + 38 tests | **Flutter 4 — Client Dio + providers** |
