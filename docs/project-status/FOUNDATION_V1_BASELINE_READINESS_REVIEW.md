...
`cores/quality-core/RELEASE_PROCESS_RUNBOOK.md` §3.1 est **prêt pour une décision humaine de
...
| Gate | Résultat |
|---|---|
| `env NODE_ENV=test node cores/quality-core/scripts/quality-gates.mjs run all-safe` | PASS 16/17 jusqu'au gate `npm audit` |
