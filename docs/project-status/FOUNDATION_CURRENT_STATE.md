...
succès iOS artificiel. `web-angular` est **`AUTH_ROUTING_READY`** (Angular 3,
2026-07-16 — starter Angular 22.0.6 + Material 22.0.4 + thème M3 Enistere + auth shell Signals, guards, interceptor Bearer mémoire, login/dashboard + tests Angular). Le seul core encore vide est `ai-core`.
...
| Cores vides | `ai-core` ; `web-angular` passe à **`AUTH_ROUTING_READY`** (Angular 3, 2026-07-16 — starter Angular 22.0.6 + Material/CDK 22.0.4 + thème M3 Enistere + AuthService Signals read-only + guards + intercepteur Bearer mémoire + routes `/login`/`/dashboard` ; prochaine action : Web Core Angular 4 — Client HTTP + server state) |
...
enistere-os-foundation/
  ...
  cores/
    ...
    ai-core/               → vide
    web-angular/           AUTH_ROUTING_READY (Angular 3, 2026-07-16 — auth shell Signals + guards + interceptor + routes login/dashboard)
  packages/
...
| `web-angular` | oui | **oui** (`CORE_SPECIFICATION.md` 32 §, `README.md` — Angular 1, 2026-07-15) | **oui** (Angular 2 starter + Angular 3 auth/routing — AuthService Signals read-only, guards, AuthInterceptor, login/dashboard ; tests Angular) | **AUTH_ROUTING_READY** |
