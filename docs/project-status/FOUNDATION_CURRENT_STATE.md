...
| Docs Core | **`docs-core`** — **SPECIFICATION_DOCUMENTAIRE** (Docs Core 1, 2026-07-12) : `CORE_SPECIFICATION.md`, `README.md`, index central `docs/README.md` (strategy, ADR, project-status, runbooks, prompts, quality gates). Aucun runtime, workflow, dépendance, RAG, génération ou site documentaire. |
