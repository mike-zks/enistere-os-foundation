...
| Docs Core | **`docs-core`** — **IMPLEMENTATION_PARTIELLE** (Docs Core 1→4, 2026-07-12) : `CORE_SPECIFICATION.md`, `README.md`, index central `docs/README.md` (strategy, ADR, project-status, runbooks, prompts, quality gates) + audit `DOCS_CORE_NAVIGATION_AUDIT.md` + onboarding `CONTRIBUTOR_ONBOARDING.md` + glossaire `GLOSSARY.md` + script `check-doc-links.mjs` testé. Aucun runtime applicatif, workflow, dépendance, RAG, génération ou site documentaire. |
...
enistere-os-foundation/
  ...
  cores/
    ...
    docs-core/         IMPLEMENTATION_PARTIELLE (index central docs + onboarding + glossaire + link check)
