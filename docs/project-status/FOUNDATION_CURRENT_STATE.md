...
Mobile Core React Native sont **VALIDE_V1**. Les cores encore vides
...
enistere-os-foundation/
  ...
  cores/
    ...
    ai-core/ api-spring/ mobile-flutter/ web-angular/   → vides (V3 cadrée ; ADR-034 validé ; prochaine action Mobile Flutter spec)
  packages/
