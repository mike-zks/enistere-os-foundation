...
enistere-os-foundation/
  ...
  cores/
    ...
    ai-core/               IMPLEMENTATION_AVANCEE (AI Core 10 — B1 runner + B2 citations fermés ; VALIDE_V1 différé par B3)
...
| `ai-core` | oui | oui (`CORE_SPECIFICATION.md`, `README.md`) | **oui** (`prompt-registry.json`, validateur Node pur, redaction layer, context builder, provider fake, evaluation harness, décision Retrieval/RAG V1, schema rapport d'execution, runner prompt fake-provider, citations retrieval) | **IMPLEMENTATION_AVANCEE** |
