...
| Docs Core | **`docs-core`** — **IMPLEMENTATION_AVANCEE** (Docs Core 1→6, 2026-07-12) : `CORE_SPECIFICATION.md`, `README.md`, index central `docs/README.md` (strategy, ADR, project-status, runbooks, prompts, quality gates) + audit `DOCS_CORE_NAVIGATION_AUDIT.md` + onboarding par role `CONTRIBUTOR_ONBOARDING.md` + glossaire `GLOSSARY.md` + guides `DOCUMENTATION_MAINTENANCE_GUIDE.md` / `CORE_STATUS_REVIEW_GUIDE.md` + script `check-doc-links.mjs` testé + scope `quality-gates docs` integrant le link check + rapports `DOCS_CORE_V2_READINESS_REVIEW.md` / `DOCS_CORE_GUIDES_ONBOARDING_REPORT.md` / `DOCS_CORE_CI_GATE_DECISION.md`. Aucun runtime applicatif, workflow, dépendance, RAG, génération ou site documentaire. |
...
enistere-os-foundation/
  ...
  cores/
    ...
    docs-core/         IMPLEMENTATION_AVANCEE (index central docs + onboarding par role + glossaire + guides + link check integre au gate local)
