...
succès iOS artificiel. `web-angular` est **`FORMS_MATERIAL_READY`** (Angular 5,
2026-07-16 — Angular Material form fields : `mat-form-field` outline, `matInput`, `mat-error` + `getFieldError()` pur, `mat-flat-button`, SCSS nettoyé ; construit sur Angular 4 HTTP/server-state ; build SUCCESS + 136/136 tests). Le seul core encore vide est `ai-core`.
...
| Cores vides | `ai-core` ; `web-angular` passe à **`FORMS_MATERIAL_READY`** (Angular 5, 2026-07-16 — `mat-form-field` outline + `matInput` + `mat-error` + `getFieldError()` pur (required/email/minlength/maxlength/pattern) + `mat-flat-button` + SCSS nettoyé (styles custom supprimés) ; construit sur Angular 4 HTTP/server-state ; 136/136 tests ✅ ; prochaine action : Web Core Angular 6 — Composants Foundation Enistere) |
...
enistere-os-foundation/
  ...
  cores/
    ...
    ai-core/               → vide
    web-angular/           FORMS_MATERIAL_READY (Angular 5, 2026-07-16 — mat-form-field + matInput + mat-error + getFieldError() + mat-flat-button + SCSS nettoyé)
  packages/
...
| `web-angular` | oui | **oui** (`CORE_SPECIFICATION.md` 32 §, `README.md` — Angular 1, 2026-07-15) | **oui** (Angular 2 starter + Angular 3 auth/routing + Angular 4 HTTP/server-state + Angular 5 Reactive Forms + Angular Material — `mat-form-field`, `matInput`, `mat-error`, `getFieldError()`, `mat-flat-button`) | **FORMS_MATERIAL_READY** |
