...
enistere-os-foundation/
  ...
  cores/
    ...
    cloud/             IMPLEMENTATION_AVANCEE (CI runtime API + E2E navigateur + registry GHCR + CC10 staging HTTPS réel + CC11 socle opérationnel ; VALIDE_V1 différé Redis/Compose)
