...
succès iOS artificiel. `web-angular` est **`STARTER_INITIALISE`** (Angular 2,
2026-07-15 — starter Angular 22.0.6 + Material 22.0.4 + thème M3 Enistere + 8/8 tests ✅ + build SUCCESS). Le seul core encore vide est `ai-core`.
...
| Cores vides | `ai-core` ; `web-angular` passe à **`STARTER_INITIALISE`** (Angular 2, 2026-07-15 — starter Angular 22.0.6 + Material/CDK 22.0.4 + thème M3 Enistere + 8/8 tests ✅ + build SUCCESS 340 KB ; prochaine action : Web Core Angular 3 — Auth flow + routing protégé) |
...
enistere-os-foundation/
  ...
  cores/
    ...
    ai-core/               → vide
    web-angular/           STARTER_INITIALISE (Angular 2, 2026-07-15 — starter Angular 22.0.6 + Material 22.0.4 + thème M3 Enistere ; 8/8 tests ✅ ; build SUCCESS)
  packages/
...
| `web-angular` | oui | **oui** (`CORE_SPECIFICATION.md` 32 §, `README.md` — Angular 1, 2026-07-15) | **oui** (Angular 2, 2026-07-15 — `package.json` + `angular.json` + `tsconfig.*` + `karma.conf.js` + `src/` AppComponent + HomeComponent ; 8/8 tests ✅ ; build 340 KB ; thème M3 Enistere) | **STARTER_INITIALISE** |
