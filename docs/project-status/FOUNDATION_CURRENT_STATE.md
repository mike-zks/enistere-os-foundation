...
enistere-os-foundation/
  ...
  cores/
    ...
    quality-core/      IMPLEMENTATION_AVANCEE (gates, checklists, runbooks, templates, prompts, release process utilisé, helper release/reporting)
...
| `quality-core` | oui | oui | **oui** (gouvernance qualité : gates, checklists, runbooks, templates, prompts, release process utilisé ; scripts `quality-gates` + `release-helper` + `quality-report` testés) | **IMPLEMENTATION_AVANCEE** |
