...
| Quality Core | **`quality-core`** — **IMPLEMENTATION_PARTIELLE** (Quality Core V2 Readiness Review, 2026-07-12) : `CORE_SPECIFICATION.md`, `README.md`, `QUALITY_GATES_MATRIX.md`, `BRANCH_PROTECTION_RUNBOOK.md`, **`RELEASE_PROCESS_RUNBOOK.md`**, templates GitHub PR/Issues, 3 checklists, `scripts/quality-gates.mjs` + tests (**36/36**) ; processus utilisé pour publier `foundation-v1.0.0`. **Protection `main` active via GitHub Rulesets** (`protect-main`, enforcement `active`, 8 checks requis). Aucun workflow modifié, aucune dépendance, aucun changement runtime. |
...
enistere-os-foundation/
  ...
  cores/
    ...
    quality-core/      IMPLEMENTATION_PARTIELLE (gates, checklists, runbooks, templates, release process utilisé)
