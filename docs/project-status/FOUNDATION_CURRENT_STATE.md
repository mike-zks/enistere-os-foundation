...
| Docs Core | **`docs-core`** — **SPECIFICATION_DOCUMENTAIRE** (Docs Core 1→3, 2026-07-12) : `CORE_SPECIFICATION.md`, `README.md`, index central `docs/README.md` (strategy, ADR, project-status, runbooks, prompts, quality gates) + audit `DOCS_CORE_NAVIGATION_AUDIT.md` + onboarding `CONTRIBUTOR_ONBOARDING.md` + glossaire `GLOSSARY.md`. Aucun runtime, workflow, dépendance, RAG, génération ou site documentaire. |
...
enistere-os-foundation/
  ...
  cores/
    ...
    docs-core/         SPECIFICATION_DOCUMENTAIRE (index central docs + cadrage)
...
| `docs-core` | oui | oui | non | **SPECIFICATION_DOCUMENTAIRE** |
