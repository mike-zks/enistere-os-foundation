...
succès iOS artificiel. Les cores vides restent `ai-core` et `web-angular`. `api-spring` est **`IMPLEMENTATION_AVANCEE`** (Spring Boot 6 V1 Readiness Review, 2026-07-15 : §30 10/15 satisfaits, 3/15 partiels, 1/15 non satisfait ; bloquants restants B1 audit logs + B2 URL signée ; `./mvnw verify` 71/71 ✅ ; CI L5 active).
...
enistere-os-foundation/
  ...
  cores/
    ...
    api-spring/           IMPLEMENTATION_AVANCEE (SB6 V1 Review 2026-07-15 — 10/15 §30 ✅ ; B1 audit logs + B2 URL signée bloquants ; 71/71 ✅ ; L5 CI)
...
| `api-spring` | oui | oui | **oui** (Spring Boot 4/5 — JPA + Flyway V1+V2 + Argon2id + RBAC + OpenAPI + upload + FakeStorageService ; 71/71 ✅ ; CI L5) | **IMPLEMENTATION_AVANCEE** (SB6 V1 Review, 2026-07-15 — 10/15 §30 ✅ ; B1 audit logs + B2 URL signée bloquants) |
