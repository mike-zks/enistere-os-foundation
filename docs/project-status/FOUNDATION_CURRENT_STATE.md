...
| Core en cours | **UI Kit** (`@enistere/ui-kit`, v0.1.1) — tokens **+ 19 primitives Web React** accessibles (Button/Input/Label/Text/Spinner/VisuallyHidden + Alert/Card/FormField + Dialog/Select/Toast, UI Kit 4 + Badge/Divider/Skeleton, UI Kit 5 + **LoadingState/EmptyState/ErrorState/SuccessState**, UI Kit 6) ; **181 tests**, a11y ; aligné **React 19** ; **consommé par le Web Core** |
