...
**Health/Auth/Files** ; **sans secret/déploiement/registry** ; validé localement, **14 tests Playwright verts** (Health/Auth/Files lecture + liste + **upload + suppression** — +2 Web Core Files 8)
