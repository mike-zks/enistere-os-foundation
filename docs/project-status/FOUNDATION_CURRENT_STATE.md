...
| Cores vides | `ai-core` ; `web-angular` passe à **`SPECIFICATION_DOCUMENTAIRE`** (Angular 1, 2026-07-15 — `CORE_SPECIFICATION.md` + `README.md` créés ; ADR-035 fondateur ; prochaine action : Web Core Angular 2 — Starter minimal) |
...
enistere-os-foundation/
  ...
  cores/
    ...
    ai-core/               → vide
    web-angular/           SPECIFICATION_DOCUMENTAIRE (Angular 1, 2026-07-15 — CORE_SPECIFICATION.md 32 §, README.md ; ADR-035 fondateur)
  packages/
...
| `web-angular` | oui | **oui** (`CORE_SPECIFICATION.md` 32 §, `README.md` — Angular 1, 2026-07-15) | non | **SPECIFICATION_DOCUMENTAIRE** |
