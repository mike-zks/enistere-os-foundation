...
> typescript 6.0.3, @angular/cli 22.0.0 + @angular-devkit/build-angular 22.0.0 — downgraded Node 24.14.0),
> `angular.json` (builder `@angular-devkit/build-angular:application`, esbuild),
