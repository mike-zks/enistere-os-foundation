...
- `factory/quality/core/scripts/quality-gates.test.mjs`
...
- `node factory/quality/core/scripts/quality-gates.mjs plan web-angular` ✅
- `node factory/quality/core/scripts/quality-gates.mjs run web-angular` ✅
