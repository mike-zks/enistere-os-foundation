...
> par Angular 1 + Angular 2 + Angular 3. `web-angular` est `AUTH_ROUTING_READY` tant que
> le client HTTP/server-state, les composants Foundation Angular et les modules V1 ne sont pas livrés.
